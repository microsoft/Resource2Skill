...
> **Skill Name**: The Rule of 3 (A/A/B Phrase Structure)

* **Core Musical Mechanism**: The "Rule of 3" is a structural compositional technique balancing repetition and variation. A musical idea (Phrase A) is introduced once to establish it. It is repeated a second time (Phrase A) to reinforce the pattern and fulfill listener expectation. On the third iteration, the pattern is intentionally broken (Phrase B or A') by introducing a new melody, a different chord progression, or a sudden deviation. 
* **Why Use This Skill (Rationale)**: This mechanism directly manipulates cognitive habituation. The human brain rapidly recognizes patterns. The first listen is novel; the second confirms the pattern. By the third repetition, the brain has fully mapped the sequence and attention begins to drop (boredom). Breaking the convention on the third iteration recaptures the listener's attention via surprise and tension, driving the composition forward.
* **Overall Applicability**: This applies to macro-arrangements (verse/verse/chorus), phrase structures (A/A/B/A), drum grooves (three standard bars followed by a fill), and micro-melodic motifs. It is universal across all genres, from pop vocal phrasing to classical motifs and EDM drops.
* **Value Addition**: Compared to looping a 4-bar MIDI clip infinitely, this skill encodes intentional narrative structure. It automatically creates the necessary tension and release required to keep a listener engaged, transforming a static "loop" into a dynamic "song."

### 2. Technical Breakdown

* **Step A: Rhythm & Timing**
  * **Time Signature**: 4/4 (standard).
  * **Pacing**: 12 bars total, divided into three 4-bar blocks.
  * **Block 1 (Bars 1-4)**: Idea A (Standard Rhythm, e.g., quarter notes).
  * **Block 2 (Bars 5-8)**: Idea A (Exact repetition).
  * **Block 3 (Bars 9-12)**: Idea B (Contrasting rhythm, e.g., syncopated eighth notes).

* **Step B: Pitch & Harmony**
  * **Key/Scale**: Parametric (e.g., C Minor).
  * **Block 1 & 2 Harmony**: Diatonic progression (e.g., I - ii - iii - V or minor equivalent). 
  * **Block 1 & 2 Melody**: A simple, predictable motif repeating exactly over the chords.
  * **Block 3 Harmony**: Deviates to a contrasting subdominant/dominant motion (e.g., IV - I - ii - V).
  * **Block 3 Melody**: Shifts to a higher register or introduces passing tones to heighten tension.

* **Step C: Sound Design & FX**
  * **Instrument**: Stock `ReaSynth` to demonstrate the pitch and rhythm cleanly.
  * **FX Chain**: A gentle attack and release envelope so the generated chords and melodies sit well together, plus `ReaEQ` to roll off harsh high frequencies.

* **Step D: Mix & Automation**
  * Velocity is kept consistent for the A phrases (e.g., 80) but increased slightly for the B phrase (e.g., 95) to emphasize the variation and "lift" the track.
...
|---|---|---|
| **A/A/B Structure** | MIDI note insertion | Allows precise mathematical placement of repetitions and deviations using a single generative function. |
| **Pitch & Harmony** | Scale-degree math | Ensures the generated chords and melodies remain strictly diatonic to whatever Key/Scale parameter the user provides. |
| **Sound Generation** | ReaSynth + ReaEQ FX Chain | 100% native REAPER solution guaranteeing the pattern can be heard immediately without external sample libraries. |

> **Feasibility Assessment**: 100%. The compositional concept of "The Rule of 3" is purely structural and mathematical. By programming an A/A/B phrase generator using REAPER's MIDI API, we completely replicate the tutorial's core lesson.
